...
export const followOrUnfollowSvc = async (id, idToFollow) => {
    try {
        ...
        const isFollowing = Follower.findOne({ where: { followerId: id, followingId: idToFollow } })
        if (!isFollowing) {
            ...
            console.log('SE SIGUIO CORRECTAMENTE')
        ...
        console.log('SE DEJO DE SEGUIR CORRECTAMENTE')
